...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Chinese Cultural Heritage Festival 2026 · Vancouver Water Splashing Festival" },
      { name: "description", content: "July 26, 2026 · Swangard Stadium, Burnaby BC. A city-level multicultural celebration of culture, community, food and the signature water splashing carnival." },
      { name: "author", content: "Canadian Community Service Association (CCSA)" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,500;12..96,600;12..96,700;12..96,800&family=Inter:wght@400;500;600;700&family=Noto+Serif+SC:wght@500;700&display=swap",
      },
    ],
  }),
